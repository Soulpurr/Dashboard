...
function PageHeader() {
  return (
    <div className="bg-[#15132B] m-6 flex flex-col p-[2rem]">
      <div className="flex justify-between ">
        <div className="">
          <div className="flex items-center space-x-3">
            ...
            <p className="">School November Tasks</p>
          </div>
          <div className="text-[8px] ml-12">
      ...
      <div className="flex justify-between">
        <div className="flex space-x-4">
          <div className="">
            ...
            >
              ...
              />
              <path
                d="M144.112 28.216C143.596 28.216 142.984 28.162 142.276 28.054C141.58 27.958 141.004 27.844 140.548 27.712L139.9 27.55L140.17 25.714C141.586 25.942 142.798 26.056 143.806 26.056C144.394 26.056 144.844 25.9 145.156 25.588C145.468 25.276 145.624 24.826 145.624 24.238C145.624 23.134 145.12 22.582 144.112 22.582C143.284 22.582 142.576 22.66 141.988 22.816L141.718 22.888L140.242 22.546L140.566 16.12H147.82V18.28H142.51L142.204 20.854C142.948 20.566 143.656 20.422 144.328 20.422C146.896 20.422 148.18 21.616 148.18 24.004C148.18 25.348 147.826 26.386 147.118 27.118C146.41 27.85 145.408 28.216 144.112 28.216ZM153.014 24.562H149.972V22.402H153.014V19.378H155.174V22.402H158.252V24.562H155.174V27.622H153.014V24.562Z"
                fill="white"
              />
            </svg>
          </div>
          <div className="">
            <button className="bg-[#6418C3] hidden  hover:bg-purple-600  text-white font-semibold py-2 px-4 rounded-full sm:flex items-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
              ...
              >
                <path
                  d="M13.1572 13.328H7.81715C6.27151 13.3298 4.7897 13.9447 3.69677 15.0376C2.60383 16.1305 1.989 17.6123 1.98715 19.158V20.938C1.98715 21.0706 2.03983 21.1978 2.1336 21.2915C2.22737 21.3853 2.35454 21.438 2.48715 21.438H18.4872C18.6198 21.438 18.7469 21.3853 18.8407 21.2915C18.9345 21.1978 18.9872 21.0706 18.9872 20.938V19.158C18.9856 17.6122 18.3708 16.1303 17.2778 15.0373C16.1848 13.9443 14.7029 13.3296 13.1572 13.328Z"
                  fill="white"
                />
                <path
                  d="M10.487 11.438C12.9723 11.438 14.987 9.42333 14.987 6.93805C14.987 4.45277 12.9723 2.43805 10.487 2.43805C8.00172 2.43805 5.987 4.45277 5.987 6.93805C5.987 9.42333 8.00172 11.438 10.487 11.438Z"
                  fill="white"
                />
                <path
          ...
          <div className="">
            <button className="bg-[#15132B] border-solid border-2 border-[#7879F1] hover:bg-purple-600 text-white font-semibold py-2 px-4 rounded-full">
              Private
            </button>
          </div>
          <div className="">
            <button className="bg-[#7879F1] hover:bg-purple-600 text-white font-semibold py-2 px-4 rounded-full">
              Edit
            </button>
          </div>
          <div className="">
            <button className="bg-[#15132B] hidden border-solid border-2 border-[#7879F1] hover:bg-purple-600 text-white font-semibold py-2 px-4 rounded-full sm:flex items-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <div className="flex space-x-4 items-baseline">
          <p className="w-[18rem]">Total Progress 60%</p>
